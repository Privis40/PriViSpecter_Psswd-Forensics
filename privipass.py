...
class PriViPDFReport(FPDF):
    ...
    def header(self):
        ...
        self.cell(0, 10, "PriVi-SPECTER Forensic Credential Report", ln=True)
        self.set_xy(10, 20)
    ...
    def _write_single_section(self, r):
        ...
        self.cell(60, 12, f"  {label}  ({score}/5)", fill=True, ln=True)
        self.set_text_color(0, 0, 0)
        self.ln(4)
        ...
        self.set_fill_color(26, 26, 46)
        self.set_text_color(255, 255, 255)
        self.cell(70, 7, "  Metric", fill=True, ln=False)
        self.cell(0,  7, "  Result", fill=True, ln=True)
        ...
        for m, v in rows:
            ...
            alt = not alt
            self.cell(70, 7, f"  {m}", fill=True, ln=False)
            self.cell(0,  7, f"  {_pdf_safe(str(v))}", fill=True, ln=True)
        self.ln(4)
    ...
    def _write_batch_section(self, results):
        ...
        self.set_fill_color(26, 26, 46)
        self.set_text_color(255, 255, 255)
        self.cell(10,  7, "#",             fill=True, ln=False, align="C")
        self.cell(55,  7, "Target (Masked)", fill=True, ln=False, align="C")
        self.cell(20,  7, "Score",         fill=True, ln=False, align="C")
        self.cell(25,  7, "Shannon",       fill=True, ln=False, align="C")
        self.cell(35,  7, "Crack Time",    fill=True, ln=False, align="C")
        self.cell(45,  7, "Breach Intel",  fill=True, ln=True,  align="C")
        ...
        for idx, r in enumerate(results, 1):
            ...
            self.set_fill_color(245, 245, 250) if alt else self.set_fill_color(255, 255, 255)
            alt = not alt
            self.cell(10,  6, str(idx),                          fill=True, ln=False, align="C")
            self.cell(55,  6, _pdf_safe(masked),                 fill=True, ln=False)
            self.cell(20,  6, f"{r.get('score','N/A')}/5",       fill=True, ln=False, align="C")
            self.cell(25,  6, _pdf_safe(str(r.get("shannon","N/A"))), fill=True, ln=False, align="C")
            self.cell(35,  6, _pdf_safe(r.get("crack_time","N/A")),   fill=True, ln=False, align="C")
            self.cell(45,  6, _pdf_safe(r.get("hibp","N/A")),    fill=True, ln=True,  align="C")
